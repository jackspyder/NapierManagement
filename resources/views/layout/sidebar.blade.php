<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/courses') }}"><i class="icon-chemistry"></i> Courses</a>
            </li>
            ...
            @if(Auth::user() && Auth::user()->is_admin == true)
                ...
                <li class="nav-item nav-dropdown">
                    ...
                    <ul class="nav-dropdown-items">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/admin/courses') }}"><i class="icon-list"></i> View
                                Courses</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/admin/courses/create') }}"><i class="icon-plus"></i> Add
                                Course</a>
                        </li>
                    </ul>
                </li>
