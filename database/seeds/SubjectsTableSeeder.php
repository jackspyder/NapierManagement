    ...
    public function run()
    {
        DB::table('subjects')->insert([
            [
                ...
                'summary' => 'PRINCE2 (an acronym for Projects IN Controlled Environments) is an industry standard methodology for effective project management. It is used extensively by the UK Government, and is also widely recognised and used in the private sector, both in the UK and internationally.
...
',
            ...
            [
                ...
                'awarded_by' => 'BCS & Napier University',
                'summary' => 'A program is a group of related projects managed in a coordinated manner to obtain benefits not available from managing them individually. Program management is the application of knowledge, skills, tools and techniques to meet program requirements. 
...
',
            ...
            [
                ...
                'qualification' => 'HND',
                'awarded_by' => 'BCS & Napier University',
                'summary' => 'Change management is the discipline that guides how we prepare, equip and support individuals to successfully adopt change in order to drive organizational success and outcomes.
...
• Identify the roles needed to assemble teams most likely to deliver successful change.',
            ...
            [
                ...
                'qualification' => 'B ENG',
                'awarded_by' => 'BCS & Napier University',
                'summary' => 'ITIL, formerly an acronym for Information Technology Infrastructure Library, is a set of detailed practices for IT service management (ITSM) that focuses on aligning IT services with the needs of business.
...
',
            ...
            [
                ...
                'awarded_by' => 'BCS & Napier University',
                'summary' => 'Risk management is the systematic application of principles, approach and processes to identify and assess risks and then to plan and implement a suitable response.
