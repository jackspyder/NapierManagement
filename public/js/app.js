...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(8), __webpack_require__(34).setImmediate))
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-05c25c5a", Component.options)
  } else {
    hotAPI.reload("data-v-05c25c5a", Component.options)
' + '  }
...
var render = function() {
  ...
  return _c(
    "form",
    { attrs: { action: "/purchases", method: "POST", id: "checkout-form" } },
    [
      _c("input", {
        directives: [
          {
      ...
      _c("input", {
        ...
        attrs: { type: "hidden", name: "lesson_id" },
        domProps: { value: _vm.lesson_id },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.lesson_id = $event.target.value
          }
        }
      }),
      _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-05c25c5a", module.exports)
  }
}
